...
keypoints_metadata = {'keypoints_symmetry': (joints_left, joints_right), 'layout_name': 'Human3.6M', 'num_joints': 32}
...
def generate_skeletons(video='', rf=27, output_animation=False, num_person=1, ab_dis=False):
    ...
    #video = '/content/drive/MyDrive/TXState/Reserach/GAST-Net-3DPoseEstimation-master/input_videos/video1.mp4'
...
if __name__ == "__main__":
    ...
    # video_path = '/content/drive/MyDrive/TXState/Reserach/lying_videos_of_no_fall/videos/' + args.video
    video_path = '//home/abheekp/GAST-Net-3DPoseEstimation-to-share/input_videos/ekramalam-GMDCSA24-A-Dataset-for-Human-Fall-Detection-in-Videos-5abac76/Subject 1/Fall/01.mp4'# + args.video
